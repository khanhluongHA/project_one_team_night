...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $_SESSION['username'] = $username; // Cập nhật tên trong session
		header("Location: ?act=login");
						...
						<div class="row">
							<div class="col-md-12">
								<div class="heading mb-1">
									<h2 class="title">Cập nhật thông tin cá nhân</h2>
								</div>
								<form method="POST">
									<label for="login-password" >
										Tên đăng nhập  
									</label>
									<input class="form-input form-wide" type="text" name="username" value="<?= htmlspecialchars($user['username']) ?>" required>
									<label>Email:</label> 
									<input class="form-input form-wide" type="email" name="email" value="<?= htmlspecialchars($user['email']) ?>" required>
									<label>Mật khẩu mới (nếu muốn đổi):</label>
									<input class="form-input form-wide" type="password" name="password">
