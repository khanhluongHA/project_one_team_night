                                        ...
                                        <div class="mt-4">
                                            <form class="needs-validation" method="POST">
                                                ...
                                                <div class="mb-3">
													...
													<br>
													<input class="form-control" type="email" value="<?= htmlspecialchars($user['email']) ?>"  name="email" required>

													
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label" for="password-input">Mật khẩu mới (nếu muốn đổi)</label>
