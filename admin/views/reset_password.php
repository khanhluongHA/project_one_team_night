...
// Kiểm tra nếu người dùng đã nhập email và session có chứa email cần reset
if (isset($_SESSION['reset_email'])) {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $new_password = $_POST['password'];
        $hashed_password = password_hash($new_password, PASSWORD_BCRYPT);  // Mã hóa mật khẩu mới
                                    ...
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <form method="POST">
                                                ...
                                                <button class="btn btn-dark btn-md w-100 mr-0" type="submit">
                                                    Đổi mật khẩu
                                                </button>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Don't have an account ? <a href="?act=register" class="fw-semibold text-primary text-decoration-underline"> Signup</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
