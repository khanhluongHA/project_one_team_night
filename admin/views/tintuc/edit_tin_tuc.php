                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form action="?act=sua-tin-tuc" method="POST">
                                            <input type="hidden" name="id_tin_tuc" value="<?= $tinTuc['id_tin_tuc'] ?>">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="citynameInput" class="form-label">Tiêu đề</label>
                                                        <input type="text" class="form-control" placeholder="tieu_de" name="tieu_de" value="<?= $tinTuc['tieu_de'] ?>">
                                                        <span class="text-danger">
                                                         <?= !empty($_SESSION['errors']['tieu_de'] ) ? $_SESSION['errors']['tieu_de'] : '' ?>
                                                        </span>

                                                        <label for="citynameInput" class="form-label">Nội dung</label>
                                                        <input type="text" class="form-control" placeholder="Nhập ngày đăng nhập cuối" name="noi_dung" value="<?= $tinTuc['noi_dung'] ?>">
                                                        <span class="text-danger">
