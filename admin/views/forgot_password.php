...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        // Nếu email đúng, hiển thị form để nhập mật khẩu mới
        $_SESSION['reset_email'] = $email;  // Lưu email trong session
        header('Location: ?act=reset_password');  // Chuyển hướng đến trang reset mật khẩu
    } else {
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 03:34:12 GMT -->
							...
							<div class="feature-box-content">
								...
								<form class="mb-0" method="POST">
									...
									<div class="form-footer mb-0">
										<a href="?act=login">Nhấp vào đây để đăng nhập</a>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="widget">
								...
								<ul class="contact-info">
									...
									<li>
										<span class="contact-info-label">Email:</span> <a href="https://portotheme.com/cdn-cgi/l/email-protection#4924282025092c31282439252c672a2624"><span class="__cf_email__" data-cfemail="771a161e1b37120f161a071b125914181a">[email&#160;protected]</span></a>
									</li>
									<li>
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 03:34:13 GMT -->
</html>