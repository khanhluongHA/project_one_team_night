                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập tên banner" name="ten_banner" value="<?=$banNer['ten_banner']?>">
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="file" class="form-control"  name="anh_banner" value="<?=$banNer['anh_banner']?>">
                                                        <span class="text-danger">
                                                                <?= !empty($_SESSION['errors']['anh_banner']) ? $_SESSION['errors']['anh_banner'] : ''?>
                                                        </span>
                                                    </div>
                                                <!--end col-->
                                                <div class="col-lg-12">
