                                    ...
                                    <div class="live-preview">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-nowrap align-middle mb-0">
                                                ...
                                                <tbody>
                                                    <?php foreach($nguoiDung as $index => $nguoiDung) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                                    <div class="hstack gap-3 flex-wrap">
                                                                        <a href="?act=form-sua-nguoi-dung&id_nguoi_dung=<?= $nguoiDung['id_nguoi_dung']?>" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
