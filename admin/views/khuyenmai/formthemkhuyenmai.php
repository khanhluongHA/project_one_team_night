...
<head>
    ...
    <meta charset="utf-8" />
    <title>Them Khuyen Mai | NN Shop</title>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Quản lý khuyến mãi</a></li>
                                        <li class="breadcrumb-item active">Them Khuyen Mai </li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="live-preview">
                                        <form action="?act=them-khuyen-mai" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12"> 
                                                    <div class="mb-3">
                                                        <label for="compnayNameinput" class="form-label">Mã khuyến mãi</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="emailidInput" class="form-label">Mức giảm</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhap So Luong" name="so_luong">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhap ngay_bat_dau" name="ngay_bat_dau">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhap ngay_ket_thuc" name="ngay_ket_thuc">
                                                        <span class="text-danger">
