                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhap So Luong" name="so_luong" value="<?= $khuyenmai['so_luong'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhap ngay_bat_dau" name="ngay_bat_dau" value="<?= $khuyenmai['ngay_bat_dau'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhap ngay_ket_thuc" name="ngay_ket_thuc" value="<?= $khuyenmai['ngay_ket_thuc'] ?>">
                                                        <span class="text-danger">
