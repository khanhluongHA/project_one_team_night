					...
					<div class="col-lg-9">
						<article class="post single">
							...
							<div class="post-body">
								...
								<h2 class="post-title"><?= $key['tieu_de'] ?></h2>
								...
								<div class="post-date"><input type="date" disabled value="<?= $key['ngay_dang'] ?>"></div><!-- End .post-content --> <br>
								<button type="summit" class="btn  read-more-btn mt-4">
								<li><a href="?act=chi-tiet-tin-tuc&id=<?= $key['id'] ?>">Chi tiết</a></li>
                                    </button>
