...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo1-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 03:35:47 GMT -->
            ...
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 product-single-gallery">
                            <div class="product-slider-container">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    <div class="product-item">
                                        <img class="product-single-image" src="<?= $product['hinh_anh'] ?>"  alt="product" />
                                    </div>
                            ...
                            <div class="prod-thumbnail owl-dots">
                                <div class="owl-dot">
                                    <img src="<?= $product['hinh_anh'] ?>" width="110" height="110" alt="product-thumbnail" />
                                </div>
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            <div class="price-box">
                                ...
                                <span class="new-price"><?= $product['gia_khuyen_mai'] ?></span>
                            </div>
                            <!-- End .price-box -->
                            ...
                            <div class="product-action">
                                ...
                                <a href="?act=gio-hang" class="btn btn-gray view-cart d-none">View cart</a>
                            </div>
                            <!-- End .product-action -->
                ...
                <div class="product-single-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="product-tab-reviews" data-toggle="tab" href="#product-reviews-content" role="tab" aria-controls="product-reviews-content" aria-selected="false">Bình luận (1)</a>
                        </li>
                    </ul>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-4 pb-sm-0">
                            <div class="widget mb-2">
                                ...
                                <ul class="contact-info m-b-4">
                                    ...
                                    <li>
                                        <span class="contact-info-label">Email:</span> <a href="https://portotheme.com/cdn-cgi/l/email-protection#87eae6eeebc7e2ffe6eaf7ebe2a9e4e8ea"><span class="__cf_email__" data-cfemail="bed3dfd7d2fedbc6dfd3ced2db90ddd1d3">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo1-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 03:35:49 GMT -->
</html>